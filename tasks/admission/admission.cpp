...
AdmissionTable FillUniversities(const std::vector<University> &universities, const std::vector<Applicant> &applicants) {
    ...
    std::sort(sorted_applicants.begin(), sorted_applicants.end(), [](const Applicant *a, const Applicant *b) -> bool {
        ...
        return std::tie(minus_a_points, a->student.birth_date.year, a->student.birth_date.month,
                        a->student.birth_date.day, a->student.name) <
               std::tie(minus_b_points, b->student.birth_date.year, b->student.birth_date.month,
